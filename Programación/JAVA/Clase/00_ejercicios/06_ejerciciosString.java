...
palabras que tiene. De la clase String, únicamente se pueden utilizar los métodos charAt(), trim() y length().
*/
public class ejerciciosStrings03 {
    ...
    public static void main(String[] args) {
        String cadena;
        int contador = 0;
        boolean palabra = false; // Para saber si estamos dentro de una palabra
